 ...
 */
public class UFCPayResult implements UFCResult {
     ...
     */
    public UFCPayResult(String result, Integer errCode, String errMsg, String detailInfo) {
        this.result = result;
        this.id = null;
     ...
     */
    public UFCPayResult(String result, Integer errCode, String errMsg, String detailInfo, String id) {
        this.result = result;
        this.errCode = errCode;
        this.errMsg = errMsg;
        this.detailInfo = detailInfo;
